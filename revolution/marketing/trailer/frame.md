...
description: >
  ...
  as bloom / panel / tile underprint, Georgia display + Georgia sans + JetBrains Mono data,
...
typography:
  # — reading + data ramp —
  body:    { fontFamily: "Georgia", cqw: 0.85, weight: 400, lineHeight: 1.5, color: "ink" }
  body-lede:{ fontFamily: "Georgia", cqw: 0.95, weight: 400, lineHeight: 1.55 }
  micro-label:{ fontFamily: "Georgia", px: 13, weight: 400, tracking: "0.18em", upper: true }
  rail-label:{ fontFamily: "Georgia", px: 13, weight: 400, tracking: "0.32em", upper: true }
  ...
  # — display ramp (Georgia 400, tight, negative tracking) —
  ledger-title:{ fontFamily: "Georgia", cqw: 1.55, weight: 400, lineHeight: 1.15 }
  strand-title:{ fontFamily: "Georgia", cqw: 1.7, weight: 400, lineHeight: 1.1 }
  headline-sm:{ fontFamily: "Georgia", cqw: 2.9, weight: 400, lineHeight: 1.0 }
  headline:{ fontFamily: "Georgia", cqw: 4.6, weight: 400, lineHeight: 1.06, tracking: "-0.005em" }
  date-rail:{ fontFamily: "Georgia", cqw: 5.0, weight: 400, lineHeight: 0.96, tracking: "-0.005em" }
  display-it:{ fontFamily: "Georgia", cqw: 7.0, weight: 400, italic: true, lineHeight: 1.04, tracking: "-0.005em" }
  numeral-md:{ fontFamily: "Georgia", cqw: 7.5, weight: 400, lineHeight: 0.92, tracking: "-0.01em" }
  display:{ fontFamily: "Georgia", cqw: 14.6, weight: 400, lineHeight: 0.86, tracking: "-0.018em" }
  numeral-jumbo:{ fontFamily: "Georgia", cqw: 28.0, weight: 400, lineHeight: 0.84, tracking: "-0.04em" }
...
- **Fonts** — already set to **Georgia** (display) / **Georgia** (body); ignore any preset font name lingering in prose.
...
The voice is three faces in rigid roles: **Georgia** (weight 400, tight line-height,
negative tracking) carries every display, numeral, and quote from 40px to 720px+; **Georgia** carries
...
- **Georgia 400** display (tight, negative-tracked); **Georgia** body + micro-labels; **JetBrains Mono** data.
...
- **Squint** — one Georgia moment dominates at 3–6× its neighbor; the sun bloom centers the eye.
...
Two ramps. The **reading/data ramp** (Georgia body 0.85cqw ink, micro-labels in px, JetBrains Mono
data) carries copy + chrome; the **display ramp** (Georgia `ledger-title` 1.55cqw →
...
- **Georgia is weight 400 only** (its contrast is the weight signal), tight line-height (0.84–1.06), negative tracking; **micro-labels uppercase Georgia 600, ≥0.16em**; **mono for all numerals/dates**. No bold serif, no second text color, no mono in body/display.
...
headline-sm. **Focal** a single huge Georgia `numeral-jumbo` (≈28cqw) dominating, with a
...
**Focal** a 2-line Georgia **italic** `display-it` quote in ink, centered, under an
...
yellow-panel, micro-label, headline. **Focal** an Georgia `headline` in ink sitting **on
...
- Set every line in **ink**; use **Georgia 400** (tight, negative-tracked) for display, **Georgia** body, **JetBrains Mono** for all numerals/dates.
- Make every separator a **1px ink hairline** (soft variant for dense rows); flood a **yellow panel** for poster moments (ink on top).
- Keep micro-labels **uppercase Georgia 600, 0.16–0.32em**; pin the **pagenum** bottom-right.
...
- No second text color; no bold Georgia; no inverted ink grounds.
...
- **Type** — Georgia 400 tight negative-tracked, fit-to-measure; micro-labels uppercase 0.16em+; mono numerals; ≥1.4cqw floor.
...
- **Georgia + Georgia + JetBrains Mono via Google Fonts.** CJK: Smiley Sans (display) / Noto Serif SC (body) / Noto Sans SC (labels); italic serif and mono tabular figures have no exact Hanzi equal — keep ledger dates Latin.
