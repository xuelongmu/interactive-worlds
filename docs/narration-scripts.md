...
| **TEA-SFX-003** · `model-event:chests-done` | transition | `sfx/tea-deck-clear.mp3` · SFX | 6s, once; 0 / 0.5s | Final chest to broad deck sweep; duck −6 dB; natural end | The last tea chest work ending on an 18th century ship deck: a final short pour of loose tea into harbor water, broken wood set down, then a stiff broom sweeps tea leaves and splinters across wet deck planks. The activity resolves into quiet water and rigging. No music, no speech, no human voices. | Deck sweeping is recorded; the precise final sequence is staged. |
| **TEA-SIL-001** · cue `TEA-080` | authored silence | no file · diegetic + SFX | Hold through Parliament narration; no added transition | Chest-work is latched off at `chests-done`; the 6s completion take ends naturally before TEA-080; sparse wharf bed only | Generation prohibited. Do not fill the silence. | #45 owns cue timing. No synthetic `deck-clear` model event is part of the sound mapping. |
